...
<section class="product-grid">
    ...
    <div class="product-card">
      <img src="img/parts1.jpg" alt="Bike Brake">
      <h2>Disc Brake Set</h2>
      <p class="price">₱999 <span class="discount">₱1,199</span></p>
      <p class="rating"><i class="fas fa-star"></i> 4.6 (74)</p>
    </div>

    <!-- Chain -->
    <div class="product-card">
      <img src="img/parts2.jpg" alt="Bike Chain">
      <h2>11-Speed Chain</h2>
      <p class="price">₱599 <span class="discount">₱699</span></p>
      <p class="rating"><i class="fas fa-star"></i> 4.5 (56)</p>
    </div>

    <!-- Pedals -->
    <div class="product-card">
      <img src="img/parts3.jpg" alt="Bike Pedals">
      <h2>Alloy Pedals</h2>
      <p class="price">₱449 <span class="discount">₱499</span></p>
      <p class="rating"><i class="fas fa-star"></i> 4.4 (38)</p>
    </div>

    <!-- Tires -->
    <div class="product-card">
      <img src="img/parts4.jpg" alt="Bike Tire">
      <h2>Mountain Bike Tire</h2>
      <p class="price">₱1,099 <span class="discount">₱1,299</span></p>
      <p class="rating"><i class="fas fa-star"></i> 4.7 (92)</p>
    </div>
  </section>

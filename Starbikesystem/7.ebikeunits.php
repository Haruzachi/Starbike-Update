...
<section class="product-grid">
    ...
    <div class="product-card">
      <img src="img/ebike1.jpg" alt="2-Wheel Electric Bike">
      <h2>VoltRide 2-Wheel</h2>
      <p class="price">₱29,999 <span class="discount">₱33,000</span></p>
      <p class="rating"><i class="fas fa-star"></i> 4.5 (75)</p>
    </div>

    <!-- 3-Wheel E-Trike -->
    <div class="product-card">
      <img src="img/ebike2.jpg" alt="3-Wheel Electric Trike">
      <h2>TrikeMaster 3-Wheel</h2>
      <p class="price">₱36,999 <span class="discount">₱39,500</span></p>
      <p class="rating"><i class="fas fa-star"></i> 4.6 (82)</p>
    </div>

    <!-- 4-Wheel E-Quad -->
    <div class="product-card">
      <img src="img/ebike3.jpg" alt="4-Wheel Electric Quad">
      <h2>QuadraX 4-Wheel</h2>
      <p class="price">₱42,499 <span class="discount">₱46,000</span></p>
      <p class="rating"><i class="fas fa-star"></i> 4.4 (61)</p>
    </div>
  </section>

...
<main class="content">
 ...
 <section class="product-grid">
    ...
    <div class="product-card">
      <img src="img/Helmet1.jpg" alt="Helmet">
      <h2>Rider Helmet</h2>
      <p class="price">₱1,499 <span class="discount">₱1,799</span></p>
      <p class="rating"><i class="fas fa-star"></i> 4.5 (120)</p>
    </div>

    <!-- Gloves -->
    <div class="product-card">
      <img src="img/Gloves1.jpg" alt="Gloves">
      <h2>Grip Gloves</h2>
      <p class="price">₱499 <span class="discount">₱599</span></p>
      <p class="rating"><i class="fas fa-star"></i> 4.2 (87)</p>
    </div>

    <!-- Body Protection -->
    <div class="product-card">
      <img src="img/Bodyarm.jpg" alt="Body Armor">
      <h2>Body Armor</h2>
      <p class="price">₱2,999 <span class="discount">₱3,299</span></p>
      <p class="rating"><i class="fas fa-star"></i> 4.8 (60)</p>
    </div>

    <!-- Knee Protection -->
    <div class="product-card">
      <img src="img/knee.jpg" alt="Knee Protection">
      <h2>Knee Protector</h2>
      <p class="price">₱899 <span class="discount">₱999</span></p>
      <p class="rating"><i class="fas fa-star"></i> 4.6 (70)</p>
    </div>
  </section>

...
<section class="product-grid">
    ...
    <div class="product-card">
      <img src="img/helmet2.jpg" alt="Bike Helmet">
      <h2>Bike Helmet</h2>
      <p class="price">₱999 <span class="discount">₱1,199</span></p>
      <p class="rating"><i class="fas fa-star"></i> 4.7 (110)</p>
    </div>

    <!-- Bike Gloves -->
    <div class="product-card">
      <img src="img/gloves2.jpg" alt="Bike Gloves">
      <h2>Bike Gloves</h2>
      <p class="price">₱299 <span class="discount">₱399</span></p>
      <p class="rating"><i class="fas fa-star"></i> 4.4 (89)</p>
    </div>

    <!-- Knee Pads -->
    <div class="product-card">
      <img src="img/knee2.jpg" alt="Knee Pads">
      <h2>Knee Pads</h2>
      <p class="price">₱499 <span class="discount">₱599</span></p>
      <p class="rating"><i class="fas fa-star"></i> 4.6 (95)</p>
    </div>

    <!-- Body Armor -->
    <div class="product-card">
      <img src="img/bodyarm2.jpg" alt="Body Protection">
      <h2>Body Protection Vest</h2>
      <p class="price">₱1,499 <span class="discount">₱1,699</span></p>
      <p class="rating"><i class="fas fa-star"></i> 4.5 (73)</p>
    </div>
  </section>
</body>
</html>

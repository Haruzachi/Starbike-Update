...
<main class="content">
 ...
 <section class="product-grid">
    ...
    <div class="product-card">
      <img src="img/motor1.jpg" alt="Kawasaki Unit">
      <h2>Kawasaki Ninja 400</h2>
      <p class="price">₱331,000 <span class="discount">₱350,000</span></p>
      <p class="rating"><i class="fas fa-star"></i> 4.9 (98)</p>
    </div>

    <!-- Honda -->
    <div class="product-card">
      <img src="img/motor2.jpg" alt="Honda Unit">
      <h2>Honda CBR500R</h2>
      <p class="price">₱409,000 <span class="discount">₱425,000</span></p>
      <p class="rating"><i class="fas fa-star"></i> 4.8 (76)</p>
    </div>

    <!-- Yamaha -->
    <div class="product-card">
      <img src="img/motor3.jpg" alt="Yamaha Unit">
      <h2>Yamaha YZF-R15</h2>
      <p class="price">₱164,000 <span class="discount">₱175,000</span></p>
      <p class="rating"><i class="fas fa-star"></i> 4.7 (102)</p>
    </div>

    <!-- Suzuki -->
    <div class="product-card">
      <img src="img/motor4.jpg" alt="Suzuki Unit">
      <h2>Suzuki GSX-R150</h2>
      <p class="price">₱156,000 <span class="discount">₱165,000</span></p>
      <p class="rating"><i class="fas fa-star"></i> 4.6 (85)</p>
    </div>
  </section>
